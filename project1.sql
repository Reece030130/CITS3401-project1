...
(
    ...
    christmasperiod character varying(5) COLLATE pg_catalog."default",
    easterperiod character varying(5) COLLATE pg_catalog."default",
...
(
    ...
    timeofday character varying(10) COLLATE pg_catalog."default",
...
(
    ...
    businvolvement character varying(5) COLLATE pg_catalog."default",
    heavyrigidtruckinvolvement character varying(5) COLLATE pg_catalog."default",
    articulatedtruckinvolvement character varying(5) COLLATE pg_catalog."default",
...
-- dim_crash (already provided by you)
COPY dim_crash FROM '/tmp/Project1/dim_crash.csv' WITH (FORMAT csv, HEADER false);

-- dim_date
COPY dim_date FROM '/tmp/Project1/dim_date.csv' WITH (FORMAT csv, HEADER false);

-- dim_fatalitiesPersonalInfo
COPY dim_fatalitiesPersonalInfo FROM '/tmp/Project1/dim_fatalitiesPersonalInfo.csv' WITH (FORMAT csv, HEADER false);

-- dim_geography
COPY dim_geography FROM '/tmp/Project1/dim_geography.csv' WITH (FORMAT csv, HEADER false);

-- dim_holiday
COPY dim_holiday FROM '/tmp/Project1/dim_holiday.csv' WITH (FORMAT csv, HEADER false);

-- dim_road
COPY dim_road FROM '/tmp/Project1/dim_road_df.csv' WITH (FORMAT csv, HEADER false);

-- dim_time
COPY dim_time FROM '/tmp/Project1/dim_time_df.csv' WITH (FORMAT csv, HEADER false);

-- dim_vehicle
COPY dim_vehicle FROM '/tmp/Project1/dim_vehicle_df.csv' WITH (FORMAT csv, HEADER false);

-- fact_table
COPY fact_table FROM '/tmp/Project1/fact_table.csv' WITH (FORMAT csv, HEADER false);
