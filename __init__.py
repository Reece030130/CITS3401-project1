...
if __name__ == '__main__':
    ...
    dim_table_list =[
        # dimension date
        [sheet_name, dim_tables_variables[0], ["Year","Month"] , None, "DateID", ["-9","Unknown"], "Date", "dim_date.csv"],  
        # dimension Geography
        [sheet_name, dim_tables_variables[1], None, None, "GeoID", ["-9","Unknown"], "Geo", "dim_geography.csv"],
        # dimension fatalities
        [sheet_name2, dim_tables_variables[2], None, None, "FatalityPersonalInfoId",["-9","Unknown"], "FatalitiesPI", "dim_fatalitiesPersonalInfo.csv"],
        # dimension crash
        [sheet_name, dim_tables_variables[3],None, None, "CrashID", ["-9","Unknown"],"Crash", "dim_crash.csv"],
        # dimension road
        [sheet_name2, dim_tables_variables[4], None, None, "RoadId", ["-9","Unknown"], "Road", "dim_road_df.csv"],
        # dimension vehicle
        [sheet_name,dim_tables_variables[5], None, None, "VehicleId", ["-9","Unknown"], "Vehicle", "dim_vehicle_df.csv"],
        # dimension Time
    ...
    fatal = dim_table_creation(sheet_name2, sheet_name2.columns ,None, {"Time": r"(\d{2}:\d{2}:\d{2})"}, "FatalityId",["-9", "Unknown"], "Fatality", "BITRE_Fatality.csv")
