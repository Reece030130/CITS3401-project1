...
def dim_table_creation(sheet_name: pl.DataFrame, dimension_variable: list, sort_list: list |None, extract : dict | None, dimension_primary_key: str, filter_value: list[str|int], convert_name: str, csv_name: str):
